...
Помогаю компаниям с практическим внедрением LLM, AI-агентов и внутренней инфраструктурой для нового поколения продуктов.

Мой фокус – не AI-трансформация, а инженерные задачи: создание прототипов для проверки гипотез, рассчёт стоимости
...
- inference-платформу на базе локальных моделей и своих GPU
...
Напишите мне в [Telegram](https://t.me/akrisanov). Лучше сразу коротко расскажите:

- кто вы и чем занимаетесь
- что хотите сделать и в каком контексте (продукт, бизнес-процесс, команда)
- есть ли прототип или гипотезы
- какие ограничения важны: безопасность, on-premise, бюджет, сроки
- что уже пробовали и какие проблемы возникли
- какие есть вопросы и что хотите обсудить
