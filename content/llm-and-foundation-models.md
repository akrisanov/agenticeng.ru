...
date = 2026-04-06
description = "Запись лекции о прикладном ИИ, LLM и Foundation моделях для продуктовых команд: как устроены большие языковые модели и как их применять в реальных продуктах."
[taxonomies]
tags = ["LLM", "ИИ", "Лекция"]
+++
